...
void Analysis_mc::analisi(int selezione, int num_histo_kin
  ...
  const int nSamples_eff = 12;
  const int nSamples_signal=10;
    

  const TString fileList[nSamples] = {  "gev1.root",
  ...
  UChar_t         _gen_nPh;
  _gen_nPh=20;
  UInt_t          _gen_phStatus[20];   //[_gen_nPh]
  ...
  UChar_t         _gen_nL;
  Double_t        _gen_lPt[16];   //[_gen_nL]
  Double_t        _gen_lEta[16];   //[_gen_nL]
  Double_t        _gen_lPhi[16];   //[_gen_nL]
  Double_t        _gen_lE[16];   //[_gen_nL]
  UInt_t          _gen_lFlavor[16];   //[_gen_nL]
  Int_t           _gen_lCharge[16];   //[_gen_nL]
  Int_t           _gen_lMomPdg[16];   //[_gen_nL]
  Bool_t          _gen_lIsPrompt[16];   //[_gen_nL]
  Double_t        _gen_lMinDeltaR[16];   //[_gen_nL]
  Bool_t          _gen_lPassParentage[16];   //[_gen_nL]
  Double_t        _gen_HT;
  Bool_t          _passHN_1l;
  ...
  UChar_t         _nGoodDisplaced;
  Double_t        _lIndex[20];   //[_nL]
  Double_t        _vertices[25][12];   //[_nVFit]
  Double_t        _lDisplaced[25][24];   //[_nVFit]
  Double_t        _lPt[20];   //[_nL]
  Double_t        _lEta[20];   //[_nL]
  Double_t        _lEtaSC[5];   //[_nLight]
  ...
  Float_t         _lElectronMva[5];   //[_nLight]
  Bool_t          _lElectronPassEmu[5];   //[_nLight]
  ...
  Double_t        _lInnerTrackValidFraction[20];   //[_nL]
  Double_t        _lGlobalTrackNormalizeChi2[20];   //[_nL]
  Double_t        _lCQChi2Position[20];   //[_nL]
  Double_t        _lCQTrackKink[20];   //[_nL]
  Double_t        _muonSegComp[5];   //[_nMu]
  Double_t        _lNumberOfMatchedStation[20];   //[_nL]
  Double_t        _lNumberOfValidPixelHits[20];   //[_nL]
  Double_t        _muNumberInnerHits[20];   //[_nL]
  Double_t        _lTrackerLayersWithMeasurement[20];   //[_nL]
  Bool_t          _lEleIsEB[20];   //[_nL]
  Bool_t          _lEleIsEE[20];   //[_nL]
  Double_t        _lEleSuperClusterOverP[20];   //[_nL]
  Double_t        _lEleEcalEnergy[20];   //[_nL]
  Double_t        _lElefull5x5SigmaIetaIeta[20];   //[_nL]
  Double_t        _lEleDEtaInSeed[20];   //[_nL]
  Double_t        _lEleDeltaPhiSuperClusterTrackAtVtx[20];   //[_nL]
  Double_t        _lElehadronicOverEm[20];   //[_nL]
  Double_t        _lEleInvMinusPInv[20];   //[_nL]
  Double_t        _relIso[5];   //[_nLight]
  ...
  Double_t        _ptRel[5];   //[_nLight]
  Double_t        _ptRatio[5];   //[_nLight]
  UInt_t          _selectedTrackMult[5];   //[_nLight]
  ...
  Double_t        _closestJetCsvV2[5];   //[_nLight]
  Double_t        _closestJetDeepCsv_b[5];   //[_nLight]
  Double_t        _closestJetDeepCsv_bb[5];   //[_nLight]
  ...
  Int_t           _phTTGMatchCategory[10];   //[_nPh]
  Double_t        _phTTGMatchPt[10];   //[_nPh]
  Double_t        _phTTGMatchEta[10];   //[_nPh]
  ...
  for(int sam = 0; sam < nSamples; ++sam){
    ...
    hfile[sam] = new TFile("/Users/Martina/Desktop/file/propagazione/"+fileList[sam],"read");
    ...
    inputTree[sam]->SetBranchAddress("_metSignificance", &_metSignificance, &b__metSignificance);
    ...
    inputTree[sam]->SetBranchAddress("_gen_phStatus", _gen_phStatus, &b__gen_phStatus);
    ...
    inputTree[sam]->SetBranchAddress("_gen_lMinDeltaR", _gen_lMinDeltaR, &b__gen_lMinDeltaR);
    inputTree[sam]->SetBranchAddress("_gen_lPassParentage", _gen_lPassParentage, &b__gen_lPassParentage);
    inputTree[sam]->SetBranchAddress("_gen_HT", &_gen_HT, &b__gen_HT);
    ...
    inputTree[sam]->SetBranchAddress("_nGoodDisplaced", &_nGoodDisplaced, &b__nGoodDisplaced);
    ...
    inputTree[sam]->SetBranchAddress("_closestJetDeepCsv_bb", _closestJetDeepCsv_bb, &b__closestJetDeepCsv_bb);
    //    inputTree[sam]->SetBranchAddress("_selectedTrackMult", _selectedTrackMult, &b__selectedTrackMult);
    ...
    inputTree[sam]->SetBranchAddress("_phTTGMatchCategory", _phTTGMatchCategory, &b__phTTGMatchCategory);
    inputTree[sam]->SetBranchAddress("_phTTGMatchPt", _phTTGMatchPt, &b__phTTGMatchPt);
    inputTree[sam]->SetBranchAddress("_phTTGMatchEta", _phTTGMatchEta, &b__phTTGMatchEta);
  ...
  //******************* HISTO **********************
  const int nCat=42;
  const int nDist = 141;  //Number of distributions to plo
  ...
  const TString Histnames_ossf[nDist] = {"categories","categories_talk", "prompt",
					 ...
					 "prop_mll_st", "prop_mlll","prop_pt_s", "prop_pt_t", "prop_DeltaR_lt","prop_DeltaR_ls", "prop_DeltaR_st",
					 "prop_diff_mll_st","prop_diff_mlll","prop_diff_pt_s", "prop_diff_pt_t", "prop_diff_DeltaR_lt","prop_diff_DeltaR_ls", "prop_diff_DeltaR_st",
					 "prop_diff_rel_mll_st", "prop_diff_rel_mlll","prop_diff_rel_pt_s", "prop_diff_rel_pt_t", "prop_diff_rel_DeltaR_lt","prop_diff_rel_DeltaR_ls", "prop_diff_rel_DeltaR_st"};
  ...
  const TString Xaxes[nDist] = {"categories"," ","#prompt",
				...
				"SR_2DSIP", "SR_vtxR", "SR_vtxR2D", "SR_vtxX",
				"propagated M_{ll} (l_{2}-l_{3} ) (GeV)", "propagated M_{lll} (GeV)","propagated P_{T} #left(l_{2} #right) (GeV)", "propagated P_{T} #left(l_{3} #right) (GeV)", "propagated #Delta#it{R} #left(l_{1}-l_{3} #right)","propagated #Delta#it{R} #left(l_{1}-l_{2} #right)", "propagated #Delta#it{R} #left(l_{2}-l_{3} #right)",
				"propagated-wrtPV M_{ll} (l_{2}-l_{3} ) (GeV)", "propagated-wrtPV M_{lll} (GeV)","propagated-wrtPV P_{T} #left(l_{2} #right) (GeV)", "propagated-wrtPV P_{T} #left(l_{3} #right) (GeV)", "propagated-wrtPV #Delta#it{R} #left(l_{1}-l_{3} #right)","propagated-wrtPV #Delta#it{R} #left(l_{1}-l_{2} #right)", "propagated-wrtPV #Delta#it{R} #left(l_{2}-l_{3} #right)",
  ...
  const double HistMin[nDist] = {-0.5,-0.5,-0.5,
				 ...
				 -0.5,-0.5,-0.5,-0.5,
				 0,20,0,0,0,0,0,
				 -20,-20,-10,-10,-0.7,-0.7,-0.7,
				 -100,-100,-100,-100,-30,-30,-100};
  ...
  for(int sam = 0, effsam = 0; sam < nSamples; ++sam, ++effsam){
	...
	if (v == vertice_st){
      ...
      /*if (_lFlavor[index_l[1]] ==1 && leptons_propagated[2].Pt() < 5 ) continue;
      if (_lFlavor[index_l[1]] ==0 && leptons_propagated[2].Pt() < 10 ) continue;

      if (_lFlavor[index_l[0]] ==1 && leptons_propagated[1].Pt() < 5 ) continue;
      if (_lFlavor[index_l[0]] ==0 && leptons_propagated[1].Pt() < 10 ) continue;*/


      double prop_deltaR_ls=0;
      double prop_deltaR_lt=0;
      double prop_deltaR_st=0;
      prop_deltaR_ls=  lepton_reco[0].DeltaR(leptons_propagated[1]) ;
      prop_deltaR_lt=  lepton_reco[0].DeltaR(leptons_propagated[2]) ;
      prop_deltaR_st=  leptons_propagated[2].DeltaR(leptons_propagated[1]) ;
      double prop_mll_st=0;
      prop_mll_st = (leptons_propagated[2] + leptons_propagated[1]).Mag();

      double prop_mlll= (lepton_reco[0] + leptons_propagated[2] + leptons_propagated[1]).Mag();
      ...
      cout<< lepton_reco[1].Pt()<<"   "<< lepton_reco[2].Pt()<<"  "<<lepton_reco[2].E()<<endl;
      cout<<(lepton_reco[1] + lepton_reco[2]).M()<<endl;
      cout<<"************************** propagati"<<endl;
      cout<<leptons_propagated[1].Pt()<<"  "<<leptons_propagated[2].Pt()<<"  "<<leptons_propagated[2].E()<<endl;
      cout<<prop_mll_st<<endl;
	...
	_sr_bool_vtxX[i]=false;
      ...
      double values[nDist] ={static_cast<double>(0) ,static_cast<double>(0) , static_cast<double>(promptC),
			     ...
			     prop_mll_st, prop_mlll, leptons_propagated[1].Pt(),leptons_propagated[2].Pt(), prop_deltaR_lt, prop_deltaR_ls, prop_deltaR_st,
			  

			    (prop_mll_st-(lepton_reco[1]+lepton_reco[2]).M()), (prop_mlll-sum_3l_rec.M()), (leptons_propagated[1].Pt()-lepton_reco[1].Pt()),(leptons_propagated[2].Pt()- lepton_reco[2].Pt()), (prop_deltaR_lt-lepton_reco[0].DeltaR(lepton_reco[2])) ,( prop_deltaR_ls-lepton_reco[0].DeltaR(lepton_reco[1])) , (prop_deltaR_st - lepton_reco[1].DeltaR(lepton_reco[2])),
(prop_mll_st-(lepton_reco[1]+lepton_reco[2]).M())*100/prop_mll_st, (prop_mlll-sum_3l_rec.M())*100/prop_mlll, (leptons_propagated[1].Pt()-lepton_reco[1].Pt())*100/leptons_propagated[1].Pt(),(leptons_propagated[2].Pt()- lepton_reco[2].Pt())*100/leptons_propagated[2].Pt(), (prop_deltaR_lt-lepton_reco[0].DeltaR(lepton_reco[2]))*100/prop_deltaR_lt ,( prop_deltaR_ls-lepton_reco[0].DeltaR(lepton_reco[1]))*100/prop_deltaR_ls  , (prop_deltaR_st - lepton_reco[1].DeltaR(lepton_reco[2]))*100/prop_deltaR_st


      };
            
 
/*   fabs(prop_mll_st-(lepton_reco[1]+lepton_reco[2]).M()), fabs(prop_mlll-sum_3l_rec.M()), fabs(leptons_propagated[1].Pt()-lepton_reco[1].Pt()),fabs(leptons_propagated[2].Pt()- lepton_reco[2].Pt()), fabs(prop_deltaR_lt-lepton_reco[0].DeltaR(lepton_reco[2])) ,fabs( prop_deltaR_ls-lepton_reco[0].DeltaR(lepton_reco[1])) , fabs(prop_deltaR_st - lepton_reco[1].DeltaR(lepton_reco[2])),
     fabs(prop_mll_st-(lepton_reco[1]+lepton_reco[2]).M())*100/prop_mll_st, fabs(prop_mlll-sum_3l_rec.M())*100/prop_mlll, fabs(leptons_propagated[1].Pt()-lepton_reco[1].Pt())*100/leptons_propagated[1].Pt(),fabs(leptons_propagated[2].Pt()- lepton_reco[2].Pt())*100/leptons_propagated[2].Pt(), fabs(prop_deltaR_lt-lepton_reco[0].DeltaR(lepton_reco[2]))*100/prop_deltaR_lt ,fabs( prop_deltaR_ls-lepton_reco[0].DeltaR(lepton_reco[1]))*100/prop_deltaR_ls  , fabs(prop_deltaR_st - lepton_reco[1].DeltaR(lepton_reco[2]))*100/prop_deltaR_st*/
